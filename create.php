...
if (!empty($_POST)) {
    ...
    $printprijs = ($data['gewicht'] * $filament['price']) + ($data['printtijd'] * 0.03);
...
<div class="wrapper">
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li><a href="create.php?page=<?=$page?>" class="<?= basename($_SERVER['PHP_SELF']) == 'create.php' ? 'active' : '' ?>"><i class='bx bx-plus'></i><span>Nieuwe Calculatie</span></a></li>
                ...
                <div class="form-section">
                    ...
                    <div>
                        ...
                        <select class="big" id="filament" name="filament" required>
                            <option value="" disabled selected>Selecteer een filament</option>
                    ...
                    <div>
                        ...
                        <textarea class="big" id="geconstateerde_afwijking" name="geconstateerde_afwijking" rows="4" placeholder="Beschrijf eventuele afwijkingen"></textarea>
                    </div>
                    <div class="button-span">
                        <input type="submit" value="Calculeren">
