...
<div class="wrapper">
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li><a href="filaments.php"><i class='bx bx-sushi'></i><span>Filamenten</span></a></li>
            <li><a href="costs.php"><i class='bx bx-dollar'></i><span>Kosten</span></a></li>
            <li><a href="printer.php" class="<?= basename($_SERVER['PHP_SELF']) == 'printer.php' ? 'active' : '' ?>"><i class='bx bx-printer'></i><span>Printer Beheer</span></a></li>
        </ul>
    </aside>
